...
const getTextForFileType = (fileType: string) =>
  knownFileTypes[fileType] || "unknown";
...
export const NeoDownloadLink: React.FC<
  PropsWithChildren<NeoDownloadLinkProps>
> = ({ fileType, fileSize, href, fileName, children }) => {
  return (
